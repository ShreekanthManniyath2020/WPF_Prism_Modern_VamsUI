...
public class ResourceHelper
{
    ...
    /// <summary>
    ///     get VamsUI.Vams skin
    /// </summary>
    /// <param name="skin"></param>
    /// <returns></returns>
    public static ResourceDictionary GetSkin(SkinType skin) => new()
    {
        Source = new Uri($"pack://application:,,,/VamsUI.Vams;component/Themes/Skin{skin}.xaml")
    };

    /// <summary>
    ///     get VamsUI.Vams theme
    /// </summary>
    ...
    public static ResourceDictionary GetStandaloneTheme()
    {
        return new()
        {
            Source = new Uri("pack://application:,,,/VamsUI.Vams.Shared;component/Themes/Theme.xaml")
        };
    }
}
